...
export const toDoBlockSchema = type({ type: '"to_do"', to_do: "unknown" });
export const toggleBlockSchema = type({ type: '"toggle"' });
export const codeBlockSchema = type({ type: '"code"', code: "unknown" });
...
export const imageBlockSchema = type({ type: '"image"', image: "unknown" });
export const videoBlockSchema = type({ type: '"video"' });
export const fileBlockSchema = type({ type: '"file"', file: "unknown" });
export const pdfBlockSchema = type({ type: '"pdf"' });
export const bookmarkBlockSchema = type({ type: '"bookmark"' });
export const calloutBlockSchema = type({ type: '"callout"', callout: "unknown" });
export const quoteBlockSchema = type({ type: '"quote"' });
export const equationBlockSchema = type({ type: '"equation"', equation: "unknown" });
export const dividerBlockSchema = type({ type: '"divider"', divider: "unknown" });
export const tableOfContentsBlockSchema = type({ type: '"table_of_contents"', table_of_contents: "unknown" });
